...
$(document).on('nifty.ready', function() {
    ...
    jQuery.fn.bootstrapTable.defaults.icons = {
        paginationSwitchDown: 'psi-arrow-down',
...
function invoiceFormatter(value, row) {
    return '<a href="detalle-qf6.html" class="btn-link" >' + value + '</a>';
}

// Sample format for Invoice Column.
// =================================================================
function campFormatter(value, row) {
    return '<a href="http://www.quanticmarketing.co/" target="_blank" class="btn-link" >' + value + '</a>';
}
...
function nameFormatter(value, row) {
    return '<a href="lugares-qf6.html" class="btn-link" > ' + value + '</a>';
}
